<template>
  <Head title="Create Check-in" />
  <AppLayout>
    <template #header>
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-semibold text-gray-900">Create Check-in</h1>
          <p class="mt-1 text-sm text-gray-600">
            Create a new check-in for a team member
          </p>
        </div>
        <Link
      ...
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div class="flex justify-end space-x-3">
          ...
          >
            ...
            <span v-else>Create Check-in</span>
          </button>
        </div>
      </form>
    </div>
